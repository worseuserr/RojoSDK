...
from tools.Constants import C_BAD, C_WARN,CONFIG_FILE, HELP_ALT, HELP_FLAG, RESET_ALT, RESET_FLAG,SETUP_FILE,FORCE_ALT,FORCE_FLAG,SKIP_ALT,SKIP_FLAG,VERBOSE_ALT,VERBOSE_FLAG,C_EMPHASIS, VERSION_ALT, VERSION_FLAG
...
if (force and reset):
	Output.Write(f"{C_WARN}Note: --force-setup (-f) is unnecessary with --reset (-r)\n")
